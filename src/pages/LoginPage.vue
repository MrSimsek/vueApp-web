<template>
  <div id="login-page" class="w-full">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 my-4 max-w-xs mx-auto">
      <div class="mb-4">
      ...
      <div class="flex items-center justify-between">
        <button id="login-button" class="bg-blue hover:bg-blue-dark text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
          Sign In
        </button>
